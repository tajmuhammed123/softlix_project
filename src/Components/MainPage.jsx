                  ...
                  <div className="p-3">
                    ...
                    <div className="flex justify-center mt-5">
                      <Title level={4} style={{ textAlign: "center" }}>
                        Maximize your online presence with our dynamic and
                    ...
                    >
                      ...
                      <Typography className="text-center text-white">
                        With our premium quality websites, your business will
                        make a lasting impression and stand out in the
                        compititive online market.
                      </Typography>
                      <Button
                        type="primary"
